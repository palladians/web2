...
export const AboutCard = ({ iconSrc, title, content }: AboutCardProps) => {
  return (
    <Card className="flex flex-col gap-8 rounded-[1rem] bg-gradient-to-br from-zinc-800/75 to-zinc-900/50 p-6 lg:p-12 hover:scale-[1.01] duration-300 hover:shadow-2xl transition-all">
